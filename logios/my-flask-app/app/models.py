...
def create_admin_user(username='admin', email='admin@logios.phil.uoa.gr', password='admin1231'):
...
class UploadedFile(db.Model):
    ...
    # Processing status
    processing_status = db.Column(db.String(20), default='uploaded', nullable=False)
