...
ARTIFACTS = "/app/ocr_server/ocr/artifacts/model7_artifacts.pt"
# MODEL_PATH = "ocr/artifacts/best_cpu_model_7.pth"
MODEL_PATH = "/app/ocr_server/ocr/artifacts/88_model_best_loss_0.7971.pt"
...
class Segmenter:
    ...
    def segment(self, src_page):
        ...
        for index in range(len(boxes)):
            ...
            # write coords
            ocred_text = self.model.ocr(gray_image)
